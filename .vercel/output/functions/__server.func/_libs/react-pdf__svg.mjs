import { S as Svg, k as TextInstance, e as Image, o as Stop, M as Marker, n as RadialGradient, m as LinearGradient, p as ClipPath, D as Defs, l as Tspan, T as Text, h as Polygon, g as Polyline, f as Line, E as Ellipse, j as Circle, R as Rect, i as Path, G } from "./react-pdf__primitives.mjs";
...
const TEXT_TYPES = /* @__PURE__ */ new Set([Text, Tspan]);
...
const EMPTY_SVG = { type: Svg, props: {}, children: [] };
