...
const appCss = "/assets/styles-B3AjJACY.css";
...
const $$splitComponentImporter$d = () => import("./templates-BLT1gVXU.mjs");
...
const $$splitComponentImporter$c = () => import("./onboarding-KpuNYzfz.mjs");
...
const $$splitComponentImporter$b = () => import("./dashboard-DwrXSrO2.mjs");
const Route$b = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./index-CZWUkSlo.mjs");
...
const $$splitComponentImporter$9 = () => import("./dashboard.index-Bk-0vHbi.mjs");
const Route$9 = createFileRoute("/dashboard/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./resume._id-DSlNo8sM.mjs");
