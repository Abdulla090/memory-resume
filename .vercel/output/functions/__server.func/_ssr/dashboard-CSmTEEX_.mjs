...
import { X, M as Menu, H as House, d as Files, L as LayoutTemplate, e as PenTool, W as WandSparkles, f as ChartNoAxesColumn, F as FileText, B as Briefcase, S as Settings, g as BrainCircuit, h as ChevronRight } from "../_libs/lucide-react.mjs";
...
function DashboardLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-[#f0f7ff] font-sans text-slate-800 overflow-hidden", style: {
    zoom: 0.9
  }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `
        ...
        ${isSidebarOpen ? "w-[280px] translate-x-0" : "-translate-x-full md:translate-x-0 md:w-[80px] w-[280px]"}
      `, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center px-4 mb-10 ${isSidebarOpen ? "gap-3" : "md:justify-center"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsSidebarOpen(!isSidebarOpen), className: "w-10 h-10 rounded-xl bg-blue-500 flex items-center justify-center shadow-lg shadow-blue-500/30 text-white shrink-0 cursor-pointer hover:bg-blue-600 transition-colors", title: "Toggle Sidebar", children: isSidebarOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-5 h-5" }) }),
          isSidebarOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xl font-bold text-slate-900 tracking-tight leading-tight", children: [
            "AI CV",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `px-4 mt-10 transition-opacity duration-300 ${isSidebarOpen ? "opacity-100" : "opacity-0 hidden"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-b from-white to-[#f8fbff] border border-blue-100 p-5 rounded-3xl shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-start mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-blue-600", children: "AI Memory" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full bg-blue-100 rounded-full overflow-hidden mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-blue-500 rounded-full w-[68%]" }) }),
