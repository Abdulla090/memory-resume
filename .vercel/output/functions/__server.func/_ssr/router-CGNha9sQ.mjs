...
const appCss = "/assets/styles-CfpzVeYz.css";
...
const $$splitComponentImporter$4 = () => import("./templates-BZWZ3Zk2.mjs");
...
const $$splitComponentImporter$3 = () => import("./onboarding-B6LldYFw.mjs");
...
const $$splitComponentImporter$2 = () => import("./dashboard-Dj2YZvxW.mjs");
const Route$2 = createFileRoute("/dashboard")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Generate resumes, explore adjacent roles, and manage saved outputs."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index--5kWYEPR.mjs");
...
const $$splitComponentImporter = () => import("./resume._id-BPJTRfZ0.mjs");
const Route = createFileRoute("/resume/$id")({
  head: () => ({
    meta: [{
...
const ResumeIdRoute = Route.update({
  id: "/resume/$id",
  path: "/resume/$id",
  getParentRoute: () => Route$5
});
