...
import { L as LeftCardSVG, R as RightCardSVG, C as CenterCardSVG } from "./router-DrIohiCg.mjs";
...
function HeroCards() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "relative w-full flex items-center justify-center origin-top", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { className: "absolute shadow-[0_20px_40px_rgba(0,0,0,0.15)] rounded-2xl", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { className: "absolute shadow-[0_25px_50px_rgba(37,99,235,0.25)] rounded-lg", style: {
...
function StatsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "app-frame px-4 sm:px-6 pb-16 sm:pb-24 relative", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-20 left-10 w-96 h-96 bg-blue-100/40 blur-3xl rounded-full pointer-events-none -z-10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-10 right-10 w-80 h-80 bg-sky-100/40 blur-3xl rounded-full pointer-events-none -z-10" }),
...
const BentoHeroCard = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0 pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-[-10%] left-[10%] w-[400px] h-[200px] bg-white/60 blur-2xl rounded-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-[-20%] right-[-10%] w-[600px] h-[300px] bg-white/80 blur-3xl rounded-full" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 p-6 sm:p-10 md:p-14 flex flex-col md:flex-row h-full items-center gap-8 md:gap-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-1/2 relative h-[300px] sm:h-[380px] md:h-[450px] flex justify-center items-center pointer-events-none", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-tr from-blue-300/30 via-white/50 to-blue-200/30 blur-3xl rounded-full pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-[10%] right-[5%] w-[200px] h-[150px] bg-white/70 blur-2xl rounded-full pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-[5%] left-[5%] w-[250px] h-[180px] bg-[#e0f2fe]/60 blur-3xl rounded-full pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-[260px] sm:w-[320px] md:w-[340px] h-[320px] sm:h-[380px] md:h-[400px] pointer-events-none select-none flex items-center justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-[2%] right-[2%] w-[160px] sm:w-[200px] md:w-[220px] origin-center shadow-[0_20px_40px_rgba(0,0,0,0.15)] rounded-2xl transition-transform duration-700 hover:scale-105", style: {
            transform: "rotate(10deg) translateX(15px) translateY(-15px)"
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LeftCardSVG, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-[2%] left-[2%] w-[180px] sm:w-[220px] md:w-[250px] origin-center z-10 shadow-[0_25px_35px_rgba(37,99,235,0.15)] rounded-lg transition-transform duration-700 hover:scale-105", style: {
            transform: "rotate(-8deg) translateX(-15px) translateY(10px)"
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CenterCardSVG, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-10 -left-10 w-[200px] h-[150px] bg-white/30 blur-2xl rounded-full z-20 pointer-events-none" })
        ] })
      ] })
    ] })
  ] });
...
function BentoGridSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 sm:px-6 pt-16 sm:pt-28 md:pt-40 pb-16 sm:pb-24 bg-[#f4f9ff] relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/4 w-[800px] h-[600px] bg-blue-100/40 rounded-full blur-3xl opacity-70 pointer-events-none -translate-y-1/2" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 right-0 w-[600px] h-[500px] bg-sky-100/40 rounded-full blur-3xl opacity-60 pointer-events-none" }),
