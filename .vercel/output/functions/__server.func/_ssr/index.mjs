...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BeZm7PDq.mjs");
...
const manifest = {
  "dbb32cc290c3284385b65fed8f41aeaed3fc4879a571067f87e6359594909413": {
    ...
    importer: () => import("./ai.functions-BRKG6Ifw.mjs")
  },
  ...
  "fe78a6bde38f2e143a6b1ac631e1b71217e03379b637713d0de68f4fe1a8c375": {
    functionName: "fixResumeErrors_createServerFn_handler",
    importer: () => import("./ai.functions-BRKG6Ifw.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-h1y6Ycqx.mjs").then((n) => n.r),
