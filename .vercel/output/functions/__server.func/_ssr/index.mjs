...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CU9gyYPB.mjs");
...
const manifest = {
  "dbb32cc290c3284385b65fed8f41aeaed3fc4879a571067f87e6359594909413": {
    ...
    importer: () => import("./ai.functions-D1eMHVIc.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CGNha9sQ.mjs").then((n) => n.r),
