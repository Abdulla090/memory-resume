...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BMd18CcM.mjs");
...
const manifest = {
  "dbb32cc290c3284385b65fed8f41aeaed3fc4879a571067f87e6359594909413": {
    ...
    importer: () => import("./ai.functions-CD3n4JUt.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DeA0j-s3.mjs").then((n) => n.r),
