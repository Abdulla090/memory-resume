...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C458nEjJ.mjs");
...
const manifest = {
  "dbb32cc290c3284385b65fed8f41aeaed3fc4879a571067f87e6359594909413": {
    ...
    importer: () => import("./ai.functions-BI0rXF7Q.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dg4mzvJP.mjs").then((n) => n.r),
