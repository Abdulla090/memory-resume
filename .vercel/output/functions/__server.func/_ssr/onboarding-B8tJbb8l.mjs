...
import { a as Sparkles, P as Paperclip, F as FileText, b as ArrowUp, C as CircleCheck, c as SkipForward } from "../_libs/lucide-react.mjs";
...
` + ev.target?.result);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh flex flex-col", style: {
    background: "linear-gradient(165deg, #b3d9f7 0%, #cce8ff 30%, #ddf0ff 60%, #ecf7ff 100%)"
  }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-6 py-4 flex items-center gap-2 shrink-0", children: [
    ...
    !inChat && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center px-4 pb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.h1, { initial: {
        ...
        opacity: 1,
        y: 0
      }, className: "text-3xl font-semibold text-slate-900 tracking-tight mb-2 text-center", children: "Tell me about yourself." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-sm mb-8 text-center max-w-sm", children: "Paste your resume, LinkedIn bio, career history — or just write freely." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        delay: 0.1
      }, className: "w-full max-w-[44rem] rounded-3xl overflow-hidden shadow-[0_8px_40px_-8px_rgba(0,80,200,0.18)] border border-blue-100/80", style: {
        background: "rgba(255,255,255,0.75)",
        backdropFilter: "blur(20px)"
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { ref: inputRef, value: inputText, onChange: (e) => setInputText(e.target.value), placeholder: "Paste your resume, LinkedIn summary, career history, or just write about yourself...", className: "w-full bg-transparent resize-none outline-none text-slate-800 text-[15.5px] leading-relaxed placeholder:text-slate-400 px-6 pt-6 pb-3", style: {
          minHeight: "200px"
        }, onKeyDown: (e) => {
    ...
    inChat && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 border-t border-blue-100/60 px-4 pt-3 pb-safe-4", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 rounded-2xl px-4 py-3 border border-blue-200 shadow-lg shadow-blue-100/40", style: {
