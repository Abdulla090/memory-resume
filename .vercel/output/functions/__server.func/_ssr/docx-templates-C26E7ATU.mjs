...
const noirS = StyleSheet.create({
  page: { padding: 40, fontSize: 9, fontFamily: "Helvetica", backgroundColor: "#0a0a0a", color: "#a3a3a3", justifyContent: "space-between" },
...
const prismDarkS = StyleSheet.create({
  page: { padding: 40, fontSize: 9, fontFamily: "Helvetica", backgroundColor: "#121212", color: "#9ca3af", justifyContent: "space-between" },
...
const pinnS = StyleSheet.create({
  page: { fontSize: 9, fontFamily: "Helvetica", color: "#334155", justifyContent: "space-between" },
...
const cipS = StyleSheet.create({
  page: { padding: 36, fontSize: 9, fontFamily: "Courier", backgroundColor: "#050505", color: "#00ff41", justifyContent: "space-between" },
...
const vgS = StyleSheet.create({
  page: { padding: 40, fontSize: 9, fontFamily: "Helvetica", color: "#171717", justifyContent: "space-between" },
...
const slateS = StyleSheet.create({
  page: { padding: 40, fontSize: 9, fontFamily: "Helvetica", color: "#0f172a", backgroundColor: "#f8fafc", justifyContent: "space-between" },
...
const avantS = StyleSheet.create({
  page: { padding: 36, fontSize: 9, fontFamily: "Times-Roman", color: "#000000", justifyContent: "space-between" },
...
const minimal = StyleSheet.create({
  page: { padding: 34, fontSize: 9, fontFamily: "Helvetica", color: "#111", justifyContent: "space-between" },
...
const exec = StyleSheet.create({
  page: { fontSize: 9, fontFamily: "Times-Roman", color: "#111", flexDirection: "row", justifyContent: "space-between" },
  side: { width: "33%", backgroundColor: "#111", color: "#fff", padding: 20, height: "100%", justifyContent: "space-between" },
  main: { width: "67%", padding: 22, height: "100%", justifyContent: "space-between" },
...
const nexus = StyleSheet.create({
  page: { padding: 40, fontSize: 10, fontFamily: "Helvetica", color: "#111", justifyContent: "space-between" },
...
const orbit = StyleSheet.create({
  page: { padding: 40, fontSize: 10, fontFamily: "Helvetica", color: "#222", justifyContent: "space-between" },
...
const metric = StyleSheet.create({
  page: { padding: 30, fontSize: 10, fontFamily: "Helvetica", color: "#000", justifyContent: "space-between" },
...
const carbon = StyleSheet.create({
  page: { fontSize: 9, fontFamily: "Helvetica", color: "#111", flexDirection: "row", justifyContent: "space-between" },
  bar: { width: 6, backgroundColor: "#1a1a1a", height: "100%" },
  side: { width: "30%", backgroundColor: "#f4f4f4", padding: 20, height: "100%", justifyContent: "space-between" },
  main: { width: "64%", padding: 22, height: "100%", justifyContent: "space-between" },
...
const atlas = StyleSheet.create({
  page: { fontSize: 9, fontFamily: "Helvetica", color: "#111", justifyContent: "space-between" },
...
const forge = StyleSheet.create({
  page: { fontSize: 9, fontFamily: "Helvetica", color: "#111", padding: 36, justifyContent: "space-between" },
...
const zenith = StyleSheet.create({
  page: { fontSize: 9, fontFamily: "Helvetica", color: "#111", padding: 40, justifyContent: "space-between" },
...
const vector = StyleSheet.create({
  page: { fontSize: 9, fontFamily: "Courier", color: "#e2e8f0", backgroundColor: "#0d1117", justifyContent: "space-between" },
