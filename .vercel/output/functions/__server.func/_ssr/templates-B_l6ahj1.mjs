...
import { R as ResumePreview, e as exportResumeDocx, a as exportResumePDF } from "./docx-templates-CqdonCGY.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex flex-col h-full min-h-[800px] lg:h-[calc(100vh-8rem)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-slate-200/50 backdrop-blur-3xl rounded-[2rem] p-4 sm:p-6 border border-slate-300/60 shadow-[inset_0_0_20px_rgba(0,0,0,0.02)] relative flex flex-col overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4 px-2 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExportButtons, { data: previewData, template: active, name: previewData.name })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden rounded-[1rem] shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_30px_60px_-20px_rgba(0,0,0,0.15)] bg-white relative @container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClientPDFPreview, { data: previewData, template: active }) })
      ] }) })
    ] })
  ] });
}
...
function ClientPDFPreview({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-full overflow-auto bg-slate-100 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto w-[794px] min-w-[794px] origin-top overflow-hidden rounded-sm bg-white shadow-[0_20px_50px_-24px_rgba(15,23,42,0.45)]", style: {
