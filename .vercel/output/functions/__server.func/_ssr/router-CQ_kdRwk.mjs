...
const appCss = "/assets/styles-OqfSvXSD.css";
...
const $$splitComponentImporter$d = () => import("./templates-CcQMD21l.mjs");
...
const $$splitComponentImporter$c = () => import("./onboarding-DXzcK-Pm.mjs");
...
const $$splitComponentImporter$b = () => import("./dashboard-CSmTEEX_.mjs");
const Route$b = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./index-CfC5yR8M.mjs");
...
const LeftCardSVG = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 240 320", className: "w-full h-auto drop-shadow-2xl", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
const RightCardSVG = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 240 320", className: "w-full h-auto drop-shadow-2xl", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
const $$splitComponentImporter$9 = () => import("./dashboard.index-Bn7v9Qfo.mjs");
const Route$9 = createFileRoute("/dashboard/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./resume._id-BZxPZzdF.mjs");
