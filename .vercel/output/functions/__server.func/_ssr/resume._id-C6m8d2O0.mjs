...
import { R as ResumePreview, a as exportPreviewAsPDF, e as exportResumeDocx } from "./docx-templates-DUKd6i29.mjs";
import { f as fileSaverPkg } from "../_libs/file-saver.mjs";
import { a as Route$8, u as useAppStore } from "./router-CfvqtG96.mjs";
import "./index.mjs";
import "../_libs/seroval.mjs";
import "../_libs/docx.mjs";
import { b as Sparkles, t as PenLine, L as LayoutTemplate, u as Target, v as LoaderCircle, D as Download, m as ChevronDown, F as FileText, w as FileType, x as Presentation, y as FileCode, z as Bot, X, J as Clock, R as RotateCcw, N as Send, Z as ZoomOut, d as ZoomIn, O as Trash2, q as Plus, W as WandSparkles, C as CircleCheck } from "../_libs/lucide-react.mjs";
...
function ResumeEditor() {
  ...
  const [templateModalOpen, setTemplateModalOpen] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#f8faff] text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900 relative overflow-hidden flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-blue-100/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1600px] mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-16 items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/onboarding", className: "flex items-center gap-2.5 cursor-pointer group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setVisualEditOpen(true), className: "px-3 py-1.5 text-xs font-medium text-slate-600 hover:text-slate-900 rounded-lg hover:bg-slate-50 transition-colors flex items-center gap-1.5 border border-slate-200", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: isKu ? "دەستکاریکردنی بینراو" : "Visual Edit" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setTemplateModalOpen(true), className: "px-3 py-1.5 text-xs font-medium text-purple-600 hover:text-purple-900 rounded-lg hover:bg-purple-50 transition-colors flex items-center gap-1.5 border border-purple-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutTemplate, { className: "h-3.5 w-3.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: isKu ? "نەخشەکان" : "Design" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setTailorOpen(true), className: "px-3 py-1.5 text-xs font-medium text-blue-600 hover:text-blue-900 rounded-lg hover:bg-blue-50 transition-colors flex items-center gap-1.5 border border-blue-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "h-3.5 w-3.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: isKu ? "گونجاندن" : "Tailor" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", ref: exportDropdownRef, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setExportDropdownOpen((v) => !v), disabled: exporting, className: "px-4 py-2 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 active:scale-95 transition-all shadow-[0_4px_12px_rgba(37,99,235,0.3)] rounded-xl disabled:opacity-50 flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-[1600px] w-full mx-auto grid gap-4 px-3 pb-20 pt-4 sm:gap-6 sm:px-6 sm:pb-24 sm:pt-6 lg:grid-cols-[400px_1fr] xl:grid-cols-[440px_1fr] relative z-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: `
        ...
        `, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/80 backdrop-blur-md rounded-[1.5rem] flex flex-col h-full relative overflow-hidden border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-b border-slate-100 bg-white/50 flex items-center justify-between shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-sm font-bold tracking-tight flex items-center gap-2 text-slate-900", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-4 h-4 text-blue-600" }),
              isKu ? "یاریدەدەری زیرەکی دەستکرد" : "AI Assistant"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 mt-1", children: isKu ? "داوابکە هەر شتێک بگۆڕێت، یان وەشانی پێشوو هەڵبژێرە لە خوارەوە." : "Ask to change anything, or pick a past version." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsSidebarOpen(false), className: "lg:hidden p-1.5 rounded-full text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4" }) })
        ] }),
        history.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-2 border-b border-slate-100 bg-white/30 flex items-center justify-between shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest text-slate-400", children: isKu ? "وەشانە پاشەکەوتکراوەکان" : "History" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setShowHistory((v) => !v), className: `flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md transition-colors ${showHistory ? "bg-blue-100 text-blue-700" : "text-slate-500 hover:bg-slate-200"}`, children: [
        ...
        showHistory && history.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-slate-100 bg-slate-50/80 px-4 py-2 space-y-1 max-h-44 overflow-y-auto shrink-0", children: history.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 rounded-lg px-3 py-2 hover:bg-white border border-transparent hover:border-slate-200 transition-colors group shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-slate-700 truncate font-semibold", children: h.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-slate-400 font-medium", children: new Date(h.timestamp).toLocaleTimeString([], {
              hour: "2-digit",
              minute: "2-digit"
            }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleRevert(h.id), className: "shrink-0 flex items-center gap-1 text-[11px] font-bold text-blue-600 hover:text-blue-800 opacity-0 group-hover:opacity-100 transition-opacity px-2 py-1 rounded-md hover:bg-blue-50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "w-3 h-3" }),
            " ",
            isKu ? "گێڕانەوە" : "Restore"
          ] })
        ] }, h.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-5 space-y-4", style: {
          scrollbarWidth: "thin",
          scrollbarColor: "#e2e8f0 transparent"
        }, children: [
          messages.map((msg, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex gap-3 ${msg.role === "user" ? "justify-end" : "justify-start"}`, children: [
            msg.role === "assistant" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center flex-shrink-0 shadow-[0_4px_10px_rgba(37,99,235,0.2)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 max-w-[85%]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-sm px-4 py-3 rounded-2xl leading-relaxed shadow-sm ${msg.role === "user" ? "bg-blue-600 text-white rounded-tr-sm" : "bg-white border border-slate-100 text-slate-800 rounded-tl-sm"}`, children: msg.content }),
              msg.role === "assistant" && msg.snapshotId && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleRevert(msg.snapshotId), className: "self-start flex items-center gap-1 text-[10.5px] font-bold text-slate-400 hover:text-blue-600 transition-colors mt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "w-3 h-3" }),
                " ",
          ...
          chatLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center flex-shrink-0 shadow-[0_4px_10px_rgba(37,99,235,0.2)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 text-white animate-spin" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 items-center px-5 py-4 rounded-2xl rounded-tl-sm bg-white border border-slate-100 shadow-sm", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-blue-400 animate-bounce", style: {
              animationDelay: `${i * 0.15}s`
            } }, i)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: messagesEndRef })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-white/80 backdrop-blur-md border-t border-slate-100 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleChatSubmit, className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: chatInput, onChange: (e) => setChatInput(e.target.value), placeholder: isKu ? "پوختەی کارەکەم با بەهێزتر بێت..." : "Make my summary more executive...", disabled: chatLoading, className: "w-full bg-white border border-slate-200 rounded-full pl-5 pr-14 py-3.5 text-sm shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:opacity-50 transition-all font-medium" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: !chatInput.trim() || chatLoading, className: "absolute right-2 top-2 bottom-2 w-10 rounded-full bg-blue-600 text-white flex items-center justify-center disabled:bg-slate-200 disabled:text-slate-400 transition-all shadow-sm hover:bg-blue-700 active:scale-95", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "w-4 h-4 ml-0.5" }) })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex flex-col h-full lg:h-[calc(100vh-8rem)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-slate-200/50 backdrop-blur-3xl rounded-[2rem] p-2 sm:p-4 lg:p-6 border border-slate-300/60 shadow-[inset_0_0_20px_rgba(0,0,0,0.02)] relative flex flex-col overflow-hidden h-[calc(100vh-10rem)] lg:h-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 mb-4 px-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setIsSidebarOpen(true), className: "lg:hidden flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-700 shadow-sm hover:bg-slate-50 active:scale-95 transition-all font-bold text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-4 h-4 text-blue-600" }),
              "AI Assistant"
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center rounded-xl border border-slate-200 bg-white/80 shadow-sm overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setZoom((z) => Math.max(0.5, z - 0.25)), className: "p-1.5 sm:p-2 hover:bg-slate-100 text-slate-600 transition-colors", title: "Zoom Out", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomOut, { className: "w-4 h-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] sm:text-xs font-bold text-slate-700 w-8 sm:w-10 text-center", children: [
              Math.round(zoom * 100),
              "%"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setZoom((z) => Math.min(2, z + 0.25)), className: "p-1.5 sm:p-2 hover:bg-slate-100 text-slate-600 transition-colors", title: "Zoom In", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomIn, { className: "w-4 h-4" }) })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-auto rounded-[1rem] shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_30px_60px_-20px_rgba(0,0,0,0.15)] bg-slate-100 relative @container flex justify-center p-4 sm:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center w-full max-w-[794px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: previewRef, className: "relative w-[794px] min-w-[794px] h-fit min-h-[1123px] bg-white overflow-hidden origin-top transition-transform duration-200 ease-out", style: {
    ...
    templateModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[100] flex flex-col justify-end sm:justify-center sm:items-center bg-slate-900/60 sm:p-6 backdrop-blur-md animate-in fade-in duration-300", onClick: () => setTemplateModalOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full sm:max-w-6xl bg-[#f8faff] rounded-t-[2rem] sm:rounded-[2.5rem] p-4 sm:p-8 flex flex-col max-h-[90vh] shadow-2xl animate-in slide-in-from-bottom-8 sm:zoom-in-95 duration-300 border border-white/20", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6 px-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 leading-tight", children: [
            isKu ? "هەڵبژاردنی" : "Choose a",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400", children: isKu ? "نەخشە" : "Template" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTemplateModalOpen(false), className: "w-10 h-10 rounded-full hover:bg-slate-200/50 flex items-center justify-center text-slate-500 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-2 pb-4 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-5", children: TEMPLATES.map(({
        id: id2,
        label,
        isNew
      }) => {
        const isActive = resume.template === id2;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
          setTemplate(id2);
          setTemplateModalOpen(false);
        }, className: `group relative flex flex-col items-center gap-2 rounded-[1.2rem] p-2 transition-all duration-300 text-center ${isActive ? "bg-blue-600 shadow-[0_8px_20px_rgba(37,99,235,0.2)] border-transparent scale-[1.02]" : "bg-white hover:bg-blue-50/50 border border-slate-200 hover:border-blue-200 hover:shadow-md"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full aspect-[1/1.414] rounded-[0.8rem] overflow-hidden relative shadow-[0_2px_10px_rgba(0,0,0,0.05)] bg-slate-100 border border-slate-100", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Thumbnail, { id: id2 }),
            isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-blue-600/10 flex items-center justify-center backdrop-blur-[1px] z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-10 h-10 text-blue-600 drop-shadow-md bg-white rounded-full" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full px-1 flex flex-col items-center mt-1 sm:mt-2 mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs sm:text-sm font-bold truncate w-full ${isActive ? "text-white" : "text-slate-900"}`, children: label }) }),
          isNew && !isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-0 right-0 -translate-y-1/3 translate-x-1/4 px-2.5 py-0.5 rounded-full bg-blue-500 text-white text-[9px] font-bold uppercase tracking-wider shadow-sm z-10 border-2 border-white", children: "New" })
        ] }, id2);
      }) }) })
    ] }) })
  ] });
