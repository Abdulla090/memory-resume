...
import { a as exportResumePDF, e as exportResumeDocx } from "./docx-templates-C26E7ATU.mjs";
import { f as fileSaverPkg } from "../_libs/file-saver.mjs";
import { R as Route$1, u as useAppStore } from "./router-BTQpAUON.mjs";
import "./index.mjs";
...
function NoirTemplate({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0a0a0a] text-neutral-300 p-12 font-sans flex flex-col justify-between", style: { minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }, children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white text-slate-800 font-sans", style: { minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-8 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 space-y-8 flex flex-col justify-between", children: [
          data.experience.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "col-span-1 space-y-8 flex flex-col justify-between", children: [
...
function NexusTemplate({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white text-slate-800 p-12 font-sans", style: { minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-8 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-8 space-y-8 flex flex-col justify-between", children: data.experience.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-4 space-y-8 flex flex-col justify-between", children: [
        data.skills.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
...
function OrbitTemplate({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#fafafa] text-neutral-800 p-12 font-sans", style: { minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-12 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-8 space-y-10 flex flex-col justify-between", children: data.experience.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-4 space-y-10 flex flex-col justify-between", children: [
...
function MetricTemplate({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white text-black p-10 font-sans", style: { minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-10 flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-8 space-y-10 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
...
function PrismTemplate({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#121212] text-gray-300 p-12 font-sans", style: { minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-10 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-7 space-y-10 flex flex-col justify-between", children: data.experience.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-5 space-y-10 flex flex-col justify-between", children: [
        data.skills.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "flex items-center gap-3 text-xs font-bold uppercase tracking-[0.2em] text-white mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-indigo-500 rotate-45" }),
            "Skills",
...
function VanguardTemplate({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white text-neutral-900 p-12 font-sans overflow-hidden", style: { minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-10 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-8 space-y-12 flex flex-col justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-4 space-y-12 flex flex-col justify-between", children: [
        data.skills.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
...
function PinnacleTemplate({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white text-slate-800 font-sans", style: { minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto p-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-12 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-8 space-y-12 flex flex-col justify-between", children: data.experience.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
...
function MinimalTemplate({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-12 text-[#111] font-sans flex flex-col justify-between", style: { minHeight: "1122px", width: "100%" }, children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3", style: { flex: 1, minHeight: "1122px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "col-span-1 bg-neutral-900 p-8 text-neutral-100 flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "col-span-2 p-10 flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
...
function ResumeEditor() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-shell bg-background text-foreground flex flex-col h-[100dvh] overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 grid lg:grid-cols-[380px_1fr] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "h-full overflow-y-auto bg-slate-50/50 p-4 sm:p-8 flex justify-center items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: previewRef, className: "relative w-full max-w-[850px] rounded-xl border-2 border-blue-200 shadow-[0_24px_60px_-24px_rgba(15,23,42,0.25)] bg-white overflow-hidden", children: [
