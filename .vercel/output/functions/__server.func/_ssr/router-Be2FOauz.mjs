...
const appCss = "/assets/styles-CyrrY3KE.css";
...
const $$splitComponentImporter$d = () => import("./templates-CrGBFczP.mjs");
...
const $$splitComponentImporter$c = () => import("./onboarding-mYmUA-qH.mjs");
...
const $$splitComponentImporter$b = () => import("./dashboard-B2L6hY_O.mjs");
const Route$b = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./index-B4CfHAOf.mjs");
...
const $$splitComponentImporter$9 = () => import("./dashboard.index-BBOSwSfp.mjs");
const Route$9 = createFileRoute("/dashboard/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./resume._id-DfYGAi1m.mjs");
