...
const appCss = "/assets/styles-B_TAfif1.css";
...
const $$splitComponentImporter$d = () => import("./templates-B_l6ahj1.mjs");
...
const $$splitComponentImporter$c = () => import("./onboarding-CgINUc4e.mjs");
...
const $$splitComponentImporter$b = () => import("./dashboard-BTgp69X3.mjs");
const Route$b = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./index-C-U9e-CA.mjs");
...
const $$splitComponentImporter$9 = () => import("./dashboard.index-DAm1JBkf.mjs");
const Route$9 = createFileRoute("/dashboard/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./resume._id-DFODfQ8S.mjs");
