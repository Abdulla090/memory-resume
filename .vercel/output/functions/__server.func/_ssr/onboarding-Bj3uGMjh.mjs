...
import { u as useAppStore } from "./router-CfvqtG96.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import "./index.mjs";
import "../_libs/seroval.mjs";
import { b as Sparkles, P as Paperclip, F as FileText, e as ArrowUp, a as Star, C as CircleCheck, I as ImagePlus, f as SkipForward } from "../_libs/lucide-react.mjs";
...
function ChatOnboarding() {
  ...
  const handleExtract = async () => {
    ...
    try {
      ...
      if (state === "READY_TO_TEMPLATE" || questions.length === 0) {
        addMsg({
          from: "ai",
          content: message || (isKu ? `پرۆفایلەکە وەرگیرا، ${parsed.name || "بەڕێز"}! چ ڕۆڵێک دەکەیتە ئامانج بۆ ئەم سیڤییە؟` : `Profile captured, ${parsed.name || "there"}! What role are you targeting for this resume?`)
        });
        setStage("builder");
      } else {
        addMsg({
          from: "ai",
          content: message || (isKu ? `پرۆفایلەکەتم دەستکەوت، ${parsed.name || "بەڕێز"}! تەنها چەند پرسیارێکی خێرا بۆ ئەوەی سیڤییەکەت بەهێزتر بێت.` : `Got your profile, ${parsed.name || "there"}! Just a few quick questions to make your resume even stronger.`)
        });
  ...
  const finishQA = async (all) => {
    ...
    try {
      ...
      addMsg({
        from: "ai",
        content: isKu ? `هەمووی تەواو بوو! پرۆفایلەکەت ئامادەیە، ${patched.name || "بەڕێز"}. چ ڕۆڵێک دەکەیتە ئامانج؟` : `All done! Your profile is ready, ${patched.name || "there"}. What role are you targeting?`
      });
      setStage("builder");
    } catch {
      setIsThinking(false);
      addMsg({
        from: "ai",
        content: isKu ? "پرۆفایلەکە نوێکرایەوە! چ ڕۆڵێک دەکەیتە ئامانج؟" : "Profile updated! What role are you targeting?"
      });
      setStage("builder");
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh flex flex-col relative overflow-hidden bg-sky-100", children: [
    ...
    !inChat && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col items-center justify-center px-4 pb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.h1, { initial: {
        ...
        opacity: 1,
        y: 0
      }, className: "text-3xl font-semibold text-slate-900 tracking-tight mb-2 text-center drop-shadow-sm", children: isKu ? "دەربارەی خۆتم پێ بڵێ." : "Tell me about yourself." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 font-medium text-sm mb-8 text-center max-w-sm drop-shadow-sm", children: isKu ? "سیڤییەکەت، بایۆی لینکدین، مێژووی کارکردنت دابنێ - یان تەنها بە ئازادی بنووسە." : "Paste your resume, LinkedIn bio, career history — or just write freely." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { ref: inputRef, value: inputText, onChange: (e) => setInputText(e.target.value), placeholder: isKu ? "سیڤییەکەت، پوختەی لینکدین، مێژووی کارکردن دابنێ، یان تەنها دەربارەی خۆت بنووسە..." : "Paste your resume, LinkedIn summary, career history, or just write about yourself...", className: "w-full bg-transparent resize-none outline-none text-slate-900 text-[15.5px] font-medium leading-relaxed placeholder:text-slate-400 px-6 pt-6 pb-3", style: {
          minHeight: "200px"
        }, onKeyDown: (e) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[11.5px] text-slate-400 mt-4", children: isKu ? "بۆ ناردن ⌘ + Enter" : "⌘ + Enter to submit" })
    ] }),
    inChat && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex-1 flex flex-col min-h-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 border-t border-blue-100/60 px-4 pt-3 pb-safe-4", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: inQA && curQ && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          curQ.inputType === "rating" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-3 ml-1", children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.button, { whileHover: {
            scale: 1.15
          }, whileTap: {
            scale: 0.9
          }, onClick: () => handleAnswer(star.toString(), qIdx), className: "p-1 rounded-full text-slate-300 hover:text-amber-400 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-8 h-8 fill-current drop-shadow-sm" }) }, star)) }),
          curQ.inputType !== "rating" && curQ.options.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-3", children: curQ.options.map((opt) => {
          ...
          curQ.inputType === "multiselect" && selectedOpts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleAnswer(selectedOpts.join(", "), qIdx), className: "mb-2 text-sm font-semibold text-blue-600 hover:text-blue-800 flex items-center gap-1", children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUp, { className: `w-3.5 h-3.5 ${isKu ? "-rotate-90" : "rotate-90"}` })
          ] })
        ] }, curQ.id) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 rounded-2xl px-4 py-3 border-2 border-white shadow-[0_20px_40px_-10px_rgba(2,132,199,0.3)]", style: {
          ...
          inQA && curQ && /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref: chatInputRef, value: customInput, onChange: (e) => setCustomInput(e.target.value), placeholder: curQ.placeholder || (isKu ? "وەڵامەکەت بنووسە یان لە سەرەوە هەڵبژێرە..." : "Type your answer or pick above..."), className: "flex-1 bg-transparent outline-none text-slate-800 text-[15px] placeholder:text-slate-400", onKeyDown: (e) => {
            if (e.key === "Enter" && customInput.trim()) handleAnswer(customInput.trim(), qIdx);
          } }),
          inBuild && /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: jobTarget, onChange: (e) => setJobTarget(e.target.value), placeholder: isKu ? "چ ڕۆڵێک دەکەیتە ئامانج؟ نموونە: بەڕێوەبەری پرۆژە..." : "What role are you targeting? e.g. Senior PM at a startup...", className: "flex-1 bg-transparent outline-none text-slate-800 text-[15px] placeholder:text-slate-400", onKeyDown: (e) => {
            if (e.key === "Enter") handleBuild();
          }, autoFocus: true }),
          !inQA && !inBuild && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-slate-400 text-[15px] select-none", children: stage === "generating" ? isKu ? "خەریکی دروستکردنی سیڤییەکەت..." : "Generating your resume..." : isKu ? "کەمێک چاوەڕێ بکە..." : "Hang on a second..." }),
...
const STEPS_KU = ["خوێندنەوەی چیرۆکی پیشەییت...", "دیاریکردنی خاڵە بەهێزەکان...", "دروستکردنی سەردێڕەکەت...", "نووسینی خاڵەکانی ئەزموون...", "ڕێکخستنی پوختەکەت...", "کۆتاییهێنان بە سیڤییەکەت..."];
function GeneratingLoader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-white mb-2 tracking-tight", children: isKu ? "سیڤییەکەت دەنووسرێت" : "Writing your resume" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { initial: {
      ...
      duration: 0.3
    }, className: "text-blue-300 text-sm mb-10", children: isKu ? STEPS_KU[step] : STEPS[step] }, step),
