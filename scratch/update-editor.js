...
const newHeader = `<header className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200 hidden md:block">
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                className="px-4 py-2 sm:py-2.5 text-sm font-bold text-slate-700 hover:text-slate-950 rounded-xl hover:bg-slate-50 transition-all flex items-center gap-2 border border-slate-200 bg-white shadow-sm hover:shadow-md active:scale-95"
              >
...
const newAside = `<aside
            className="relative flex flex-col gap-4 min-w-0 lg:col-start-1 lg:sticky lg:top-20 lg:h-[calc(100dvh-6rem)] hidden lg:flex bg-white rounded-3xl border border-slate-200/60 shadow-[0_24px_70px_-34px_rgba(15,23,42,0.2)] overflow-hidden"
          >
            {/* Tabs Header */}
            <div className="flex shrink-0 items-center border-b border-slate-100 p-1 bg-slate-50">
              <button
                onClick={() => setActiveTab("chat")}
                className={\`flex-1 py-2 text-sm font-bold rounded-xl transition-all flex items-center justify-center gap-2 \${
                  activeTab === "chat" ? "bg-white shadow-sm text-blue-600 border border-slate-200/50" : "text-slate-500 hover:text-slate-800"
                }\`}
              >
              ...
              <button
                ...
                className={\`flex-1 py-2 text-sm font-bold rounded-xl transition-all flex items-center justify-center gap-2 \${
                  activeTab === "design" ? "bg-white shadow-sm text-purple-600 border border-slate-200/50" : "text-slate-500 hover:text-slate-800"
                }\`}
              >
            ...
            <div className="flex-1 overflow-hidden relative">
              {activeTab === "chat" ? (
                <div className="flex h-full flex-col">
                  ...
                  <div className="px-4 pt-2 pb-1 flex gap-2 overflow-x-auto scrollbar-hide shrink-0 bg-white/90 border-t border-slate-100">
                     <button onClick={() => setChatInput("Make my bullet points stronger.")} className="whitespace-nowrap px-3 py-1.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-full text-xs font-semibold text-slate-700 transition-colors">Stronger bullets</button>
                     <button onClick={() => setChatInput("Add metrics to my experience.")} className="whitespace-nowrap px-3 py-1.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-full text-xs font-semibold text-slate-700 transition-colors">Add metrics</button>
                     <button onClick={() => setChatInput("Shorten the summary.")} className="whitespace-nowrap px-3 py-1.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-full text-xs font-semibold text-slate-700 transition-colors">Shorten</button>
                  </div>

                  <div className="flex w-full shrink-0 justify-center bg-white/90 px-4 pb-safe-6 pt-2 border-slate-100">
                    <form
                      onSubmit={handleChatSubmit}
                      className="flex w-full items-center gap-2 rounded-2xl border border-slate-200 bg-slate-50 px-2 py-2 shadow-sm transition-all duration-300 focus-within:border-blue-400 focus-within:bg-white focus-within:ring-2 focus-within:ring-blue-500/10 sm:gap-3"
                    >
                      <textarea
                        value={chatInput}
                      ...
                      <button
                        ...
                        className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-blue-600 text-white shadow-sm transition-all hover:bg-blue-700 disabled:bg-slate-200 disabled:text-slate-400"
                      >
            ...
            <div
              className="hidden lg:block absolute top-0 right-0 h-full w-1.5 cursor-col-resize bg-transparent hover:bg-blue-500/20 z-10"
              onMouseDown={(e) => {
                e.preventDefault();
