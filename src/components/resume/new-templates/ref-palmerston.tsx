  ...
  return (
    <div dir={rtl ? "rtl" : "ltr"} className="relative overflow-hidden bg-white font-sans text-[#111827]" style={{ height: "1122px", minHeight: "1122px", width: "794px", maxWidth: "100%" }}>
      <header className="absolute left-0 top-0 h-[208px] w-full bg-white">
        <div className="absolute left-0 top-0 h-[205px] w-[285px] rounded-br-[48px] bg-[#303b4e] rtl:left-auto rtl:right-0 rtl:rounded-br-none rtl:rounded-bl-[48px]">
          <div className="absolute left-[59px] top-[34px] rtl:left-auto rtl:right-[59px]">
            <PhotoBlock data={c} shape={photoBlockShape} />
          </div>
        </div>
        <div className="ml-[330px] pt-[64px] rtl:ml-0 rtl:mr-[330px]">
          <Editable path="name" value={c.name} as="h1" className="max-w-[420px] text-[43px] font-black uppercase leading-[0.98] tracking-[0.02em] text-[#1f3148] rtl:tracking-normal" />
          <Editable path="title" value={c.title} as="p" className="mt-3 text-[16px] font-semibold uppercase tracking-[0.38em] text-[#1f3148] rtl:tracking-normal" />
        </div>
      </header>
      ...
      <aside className="absolute bottom-0 left-0 top-[296px] w-[286px] bg-[#303b4e] px-[49px] py-[50px] text-white rtl:left-auto rtl:right-0">
        ...
        {c.certifications.length > 0 && (
          <section className="mt-9">
            ...
            <ul className="mt-5 list-disc space-y-2 pl-4 text-[12px] font-semibold leading-[1.35] rtl:pl-0 rtl:pr-4">
      ...
      <main className="absolute bottom-[34px] left-[326px] right-[32px] top-[340px] rtl:left-[32px] rtl:right-[326px]">
        <section>
