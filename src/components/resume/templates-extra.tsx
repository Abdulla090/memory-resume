  ...
  return (
    <div className="bg-[#0a0a0a] text-neutral-300 p-12 font-sans" style={{ minHeight: "1122px", width: "100%", display: "flex", flexDirection: "column" }}>
      <header className="border-b border-neutral-800 pb-6 text-center">
        ...
        <p className="mt-4 text-xs text-neutral-600 tracking-widest uppercase">
      ...
      <div className="mt-12 space-y-8">
        {data.experience.length > 0 && (
          <section>
            <h2 className="mb-4 text-[10px] font-bold uppercase tracking-[0.3em] text-neutral-600 border-b border-neutral-800 pb-2">Experience</h2>
            <div className="space-y-6">
              {data.experience.map((e, i) => (
                <div key={i}>
                  <div className="flex items-baseline justify-between">
                    <div className="text-base text-white">{e.title} <span className="text-neutral-500 italic">· {e.company}</span></div>
                    <div className="text-xs text-neutral-600 tracking-wider">{e.duration}</div>
                  </div>
                  {e.description && <p className="mt-1.5 text-sm text-neutral-400">{e.description}</p>}
                  <ul className="mt-2 space-y-1 text-sm text-neutral-400">
                    {e.achievements.map((a, j) => (
                      <li key={j} className="flex gap-2"><span className="text-neutral-700">›</span> {a}</li>
                    ))}
                  </ul>
                </div>
              ))}
              ...
              <div className="space-y-4">
                {data.projects.map((p, i) => (
                  <div key={i}>
                    ...
                    {p.tech.length > 0 && <p className="mt-1 text-[10px] tracking-wider text-neutral-600 uppercase">{p.tech.join(" · ")}</p>}
                  </div>
                ))}
              </div>
            </section>
          ...
          <div>
            {data.skills.length > 0 && (
              <section className="mb-8">
                <h2 className="mb-4 text-[10px] font-bold uppercase tracking-[0.3em] text-neutral-600 border-b border-neutral-800 pb-2">Skills</h2>
            ...
            {data.education.length > 0 && (
              <section>
                <h2 className="mb-4 text-[10px] font-bold uppercase tracking-[0.3em] text-neutral-600 border-b border-neutral-800 pb-2">Education</h2>
      ...
      <div className="p-12">
        ...
        <div className="grid grid-cols-3 gap-8 flex-1">
          <div className="col-span-2 space-y-8">
                ...
                <div className="space-y-5">
                  {data.experience.map((e, i) => (
                    <div key={i}>
                      ...
                      <ul className="list-disc space-y-1 pl-4 text-sm text-slate-600 marker:text-slate-300">
            ...
            {data.projects.length > 0 && (
              <section>
                <h2 className="text-lg font-bold text-slate-900 mb-4 border-b-2 border-slate-100 pb-2">Projects</h2>
                <div className="space-y-4">
                  {data.projects.map((p, i) => (
                    <div key={i}>
          ...
          <aside className="col-span-1 space-y-8">
            {data.skills.length > 0 && (
              <section>
                <h2 className="text-lg font-bold text-slate-900 mb-4 border-b-2 border-slate-100 pb-2">Skills</h2>
            ...
            {data.education.length > 0 && (
              <section>
                <h2 className="text-lg font-bold text-slate-900 mb-4 border-b-2 border-slate-100 pb-2">Education</h2>
                <div className="space-y-4">
                  {data.education.map((e, i) => (
                    <div key={i}>
            ...
            {data.certifications.length > 0 && (
              <section>
                <h2 className="text-lg font-bold text-slate-900 mb-4 border-b-2 border-slate-100 pb-2">Certifications</h2>
              ...
              <div className="space-y-6 relative before:absolute before:inset-0 before:ml-[5px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
                {data.experience.map((e, i) => (
                  <div key={i} className="relative pl-6">
                    <div className="absolute left-0 top-1.5 w-3 h-3 rounded-full bg-white border-2 border-blue-600 z-10 -ml-[5px]"></div>
